...
public class MockedValues {
    ...
    public static final Map<Product, List<DeliveryMethod>> PRODUCTS_WITH_DELIVERY_METHODS = Map.of(new Product("Fond - Chocolate"), List.of(new DeliveryMethod("Pick-up point"), new DeliveryMethod("Express Collection"), new DeliveryMethod("Mailbox delivery")),
    ...
    public static final Map<DeliveryMethod, List<Product>> EXPECTED_GROUPS = Map.of(new DeliveryMethod("Pick-up point"), List.of(new Product("Chocolate - Unsweetened"), new Product("Fond - Chocolate")));
}
